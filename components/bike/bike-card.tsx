...
export default function BikeCard({
  ...
  // Reference reach/stack (middle size or first)
  ...
  return (
    ...
    >
      ...
      <CardHeader className="pb-2">
        ...
        <CardTitle className="text-base font-bold tracking-tight group-hover:text-lime-400 transition-colors">
          {bike.model}
        </CardTitle>
        {/* Tags */}
